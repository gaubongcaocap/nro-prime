...
public class NpcService {
    ...
    public void createMenuRongICE(Player player, int indexMenu, String npcSay, String... menuSelect) {
        createMenu(player, indexMenu, (byte) ConstNpc.RONG_ICE, 124, npcSay, menuSelect);
    }
