...
public class BossesData {
    ...
    public static final BossData minuong = new BossData(
            ...
            90000, //dame
            new double[]{300_000_000}, //hp
            new int[]{0, 7, 14, 5, 13, 20, 6}, //map join
            new int[][]{
                {Skill.MASENKO, 3, 1000},
                {Skill.LIEN_HOAN, 7, 1000}},
            new String[]{"|-1|Hế lô em,anh đứng đây từ chiều",
    ...
    public static final BossData BLACKGOKU = new BossData(
            ...
            new int[][]{
                {Skill.MASENKO, 3, 1000},
                {Skill.LIEN_HOAN, 7, 1000}},
            new String[]{"|-1|Chào! Có Gôku ở đây không?",}, //text chat 1
            new String[]{"|-1|Ngươi thực sự rất mạnh dù không phải là một rôbốt. Ngươi không phải là Piccôlô",}, //text chat 2
            new String[]{"|1|Pic tiêu rồi, tớ lên trước nhé!",
                "|-3|Okê, xin cứ tự nhiên"
            },
            REST_15_M //second rest
    );
    public static final BossData ZAMUS = new BossData(
            "Super Zamus", //name
            ConstPlayer.TRAI_DAT, //gender
        ...
        public static final BossData BOJACK_GIANGHO = new BossData(
            ...
            new int[]{BossID.ZANGYA_GIANGHO, BossID.KOGU_GIANGHO, BossID.BUJIN_GIANGHO, BossID.BIDO_GIANGHO} //boss join map together
    );
    ...
    ///test
    public static final BossData VEGETA4 = new BossData(
            "Super Saiyan 4 Vegeta", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1755, 1756, 1757, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            50000, //dame
            new double[]{1000000000L}, //hp
            new int[]{92, 93, 94, 96, 97, 98, 99, 100}, //map join
            new int[][]{
    ...
    public static final BossData KAKAROT4 = new BossData(
            "Super Saiyan 4 Kakarot", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1752, 1753, 1754, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            50000, //dame
            new double[]{1000000000L}, //hp
            new int[]{92, 93, 94, 96, 97, 98, 99, 100}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_KAMEJOKO), //skill
...
//**************************************************************************
    ...
    public static final BossData CUMBER = new BossData(
            ...
            new int[][]{
                {Skill.LIEN_HOAN, 7, 1000},
                {Skill.ANTOMIC, 7, 1000}, //                {Skill.TAI_TAO_NANG_LUONG, 7, 90000}
    ...
    public static final BossData Toppo = new BossData(
            "Siêu Toppo", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1986, 1987, 1988, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
    ...
    public static final BossData DORAEMON = new BossData(
            ...
            new int[][]{
                {Skill.DRAGON, 7, 1000},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 30000},}, //skill//skill
    ...
    public static final BossData GOKUSSJ = new BossData(
            "Goku SSJ", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{0, 523, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            50000, //dame
            new double[]{4_000_000_000L}, //hp
    ...
    public static final BossData thucung = new BossData(
            "Thú Cưng LEVEL 1", //name
            ConstPlayer.TRAI_DAT, //gender
            ...
            new String[]{"|-1|Ta là Thú cưng mạnh nhất",
                "|-1|Cơ thể này,sức mạnh này",}, //text chat 1
            new String[]{"|-1|Các ngươi chỉ có vậy thôi sao?",
                "|-1|Được thôi, nếu muốn chết đến vậy, ta rất vui lòng!!"
            }, //text chat 2
            new String[]{"|-1|Biến hình!"}, //text chat 3
    ...
    public static final BossData lanme = new BossData(
            "Kì lân mẹ", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1894, 1895, 1896, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    //ok
    public static final BossData SUPER_BLACK_GOKU = new BossData( //hmmm
    ...
    public static final BossData SUPER_CUMBER = new BossData(
            "Super Cumber", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1983, 1984, 1985, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new double[]{2_000_000_000L}, //hp
            new int[]{92, 93, 94, 96, 97, 98, 99, 100}, //map join
            new int[][]{
    ...
    public static final BossData PicoloDaimaku = new BossData(
            "Piccolo Daimaku", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1360, 1361, 1362, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new double[]{2_000_000_000L}, //hp
            new int[]{92, 93, 94, 96, 97, 98, 99, 100}, //map join
            new int[][]{
    ...
    public static final BossData zenosama = new BossData(
            "Boss Thế Giới Zeno", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1470, 1471, 1472, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
            new double[]{50_000_000_000L}, //hp
            new int[]{209}, //map join
            new int[][]{
                {Skill.TAI_TAO_NANG_LUONG, 1, 560000},
    ...
    public static final BossData SieuAndroid17 = new BossData(
            "Super Android17", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1980, 1981, 1982, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new double[]{2_000_000_000L}, //hp
            new int[]{92, 93, 94, 96, 97, 98, 99, 100}, //map join
            new int[][]{
    ...
    public static final BossData OngGiaNoel = new BossData(
            "Ông Già Noel", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{657, 658, 659, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new double[]{5000000000L}, //hp
            new int[]{105, 5, 6, 7, 9, 10, 11, 12}, //map join
            new int[][]{
                //                {Skill.DICH_CHUYEN_TUC_THOI, 7, 15000},
                {Skill.THAI_DUONG_HA_SAN, 1, 100000000},},
            //skill
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
    ...
    public static final BossData Mabu = new BossData(
            ...
            new double[]{Util.nextInt(1000000000, 2000000000)}, //hp
            new int[]{6, 27, 28, 29, 30, 13, 31, 32, 33, 34, 10, 19, 20, 35, 36, 37, 38}, //map join
    ...
    public static final BossData SuperBroly = new BossData(
            ...
            new short[]{291, 292, 293, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            Util.nextInt(100, 500000), //dame
            new double[]{Util.nextInt(500, 5000)}, //hp
            new int[]{6, 27, 28, 29, 30, 13, 31, 32, 33, 34, 10, 19, 20, 35, 36, 37, 38}, //map join
            new int[][]{{Skill.KAMEJOKO, 7, 6, 5, 4, 3, 2, 1, 100},
            {Skill.ANTOMIC, 7, 6, 5, 4, 3, 2, 1, 100},
            {Skill.MASENKO, 7, 6, 5, 4, 3, 2, 1, 100},
    ...
    public static final BossData LIU_LIU = BossData.builder()
        ...
        {Skill.DRAGON, 1, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
        {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700},
        {Skill.GALICK, 1, 100}, //                    {Skill.THAI_DUONG_HA_SAN, 1, 15000}
    })
            .secondsRest(REST_5_S)
            .build();
    ...
    public static final BossData Super_Zamus = new BossData(
            "Fusion Zamasu", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1680, 1681, 1682, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            50000, //dame
            new double[]{10000000000L}, //hp
            new int[]{92, 93, 94, 96, 97, 98, 99, 100}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_KAMEJOKO), //skill
            new String[]{"|-1|Ta vị thần",
                "|-1|Cơ thể này,sức mạnh này",
                "|-1|Ta khá thích việc loại bỏ các ngươi",
                "|-1|Mau chấp nhận số phận đi lũ sâu bọ"
            }, //text chat 1
    ...
    public static final BossData Super_Zamus2 = new BossData(
            ...
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1829, 1830, 1831, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100000, //dame
            new double[]{1000000000L}, //hp
            new int[]{92, 93, 94, 96, 97, 98, 99, 100}, //map join
            new int[][]{
