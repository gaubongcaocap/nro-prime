...
public class Pet extends Player {
    ...
    private String getTextStatus(byte status) {
        switch (status) {
            case FOLLOW:
                return "Con sẽ theo sư phụ mà";
            case PROTECT:
                return "Mày dám đánh sự phụ của tao à";
            case ATTACK:
                return "Ok sư phụ để con lo";
            case GOHOME:
...
//    }
    ...
    private void increasePoint() {
        if (this.nPoint != null) {
            this.nPoint.increasePoint((byte) 0, (short) Util.nextInt(1, 100));
            this.nPoint.increasePoint((byte) 1, (short) Util.nextInt(1, 100));
            this.nPoint.increasePoint((byte) 2, (short) 10);
        }
    }
    ...
    public short getAvatar() {
        if (this.typePet == 1) {
            ...
            return 1680;
        } else if (this.typePet == 6) { //bư lvl2
            return 439;
        } else if (this.typePet == 7) { //bư lvl2
            return 508;
        } else if (this.typePet == 8) {
            return 1318;
        } else if (this.typePet == 9) { //pet gohan xác ướp
            return 1431;
    ...
    public short getHead() {
        if (effectSkill.isMonkey) {
            ...
            return 412;
        } else if (this.typePet == 1) { //pet mabu
            return 297;
        } else if (this.typePet == 2) { //pet berus
            return 511;
        } else if (this.typePet == 3) { //pet sieu broly
            return 291;
        } else if (this.typePet == 4) { //pet gohan xác ướp
            return 462;
        } else if (this.typePet == 5) { //pet goku EVO
            return 1680;
    ...
    public short getBody() {
        if (effectSkill.isMonkey) {
            ...
            return 292;
        } else if (this.typePet == 4 && !this.isTransform) { //pet gohan xác ướp
            return 463;
        } else if (this.typePet == 5 && !this.isTransform) { //pet goku evo
            return 1681;
        } else if (this.typePet == 6) {
            return 440;
...
//    ========================================================
    ...
    public void transform() {
        ...
        if (this.typePet == 2) {
            ...
            Service.getInstance().Send_Caitrang(this);
            try {
                Service.getInstance().chat(this, "Tao là thần huỷ diệt");
            } catch (Exception ex) {
                Logger.getLogger(Pet.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if (this.typePet == 3) {
            ...
            Service.getInstance().Send_Caitrang(this);
            try {
                Service.getInstance().chat(this, "Tao người Xayda");
            } catch (Exception ex) {
                Logger.getLogger(Pet.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if (this.typePet == 4) {
            ...
            Service.getInstance().Send_Caitrang(this);
            try {
                Service.getInstance().chat(this, "Tao là tề thiên đại thánh");
            } catch (Exception ex) {
                Logger.getLogger(Pet.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
