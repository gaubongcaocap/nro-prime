...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_MOC_NAP = "Nguyên liệu cần để làm Dồ Thiên sứ là :\n"
            + "1 Công thức theo Hành tinh mong muốn + 1 Đá cầu vòng + 999 Mảnh thiên sứ\n"
            + "Lưu ý: Đồ thiên sứ sẽ ra hảnh tinh theo Thông tin của Công thức";
    //npcid
    ...
    public static final byte DOI_QUA = 126;
    ...
    public static final byte RONG_BANG = 102;
    public static final byte NPC_EVENT = 85;
    public static final byte Toppo = 86;
    public static final byte maygap = 87;
    public static final byte ATM = 88;
    public static final byte trungdetu = 89;
    public static final byte gogetassj4 = 90;
    public static final byte rongomega = 91;
    public static final byte champa = 92;
    //----------------------index menu------------------------------------------
    ...
    public static final int XMAP = 1232302;

    public static final int MENUCUONGHOASKH = 143432302;
    public static final int MENUFUSIONSKH = 14343202;
    public static final int MAP_TUONG_LAI = 1434432302;
    public static final int MENU_AUTO = 712002323;

    
    public static final int DOBOSS = 7323323;
    public static final int AUTO_ITEM = 712011323;
    public static final int NRO_SIEU_CAP = 752243002;
    public static final int DOI_TIEN = 555;
    public static final int MENU_DOITIEN1 = 556;
    public static final int MENU_DOITIEN2 = 557;

    public static final int MENU_DUNG_HOP = 55332327;
    public static final int DTMABU = 12011323;
    public static final int APTRUNG = 12022323;
    public static final int LUACHONTRUNG = 120211323;
    public static final int DTSUPER = 1211323;
    public static final int DTZAMUS = 1201323;
    public static final int DTWUKONG = 12013;
    public static final int DTBERUS = 12223013;
    public static final int CALL_BOSS = 52300;
    //index quy lão kamê
    ...
    public static final int DOI_QUA_MENU = 103;
    public static final int TANG_DIEM_SB = 1222303;
    ///
    public static final int MENU_DI_CHUYEN = 500;
    public static final int MENU_THUC_TINH = 503;
    ...
    public static final int MENU_START_COMBINELVL = 52321303;
    ...
    public static final int TUTORIAL_RONG_XUONG = 5704;
      public static final int TUTORIAL_RONG_ICE = 5707;
    public static final int RONG_HALLOWEN = 5705;
    public static final int RONG_ICE = 1705;
    public static final int MENU_QUAN_LY_PLAYER = 23505;

    public static final int RUONG_PHU = 5210;
    ...
    public static final int MENU_OPTION_USE_ITEM1533 = 1533;
    public static final int MENU_OPTION_USE_ITEM1534 = 1534;
    public static final int MENU_OPTION_USE_ITEM1535 = 1535;

    public static final int MENU_OPTION_USE_ITEM736 = 736;
    public static final int MENU_OPTION_USE_ITEM1105 = 1105;

    public static final int SELECTSKH = 523223222;
...
//    public static final int SHENRON_3 = 505;
    ...
    public static final int ICE_CONFIRM = 522309;

    public static final int HALLOWEN_1_1 = 508;
    public static final int ICE_1_1 = 522308;
