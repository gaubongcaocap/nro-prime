...
public class NPoint {
     ...
     * //+#% sức đánh chí mạng
     */
    public int damekaioken, damegalick, damelienhoan;
       ...
       if (this.player.setClothes.nappa == 5) {
        ...
        if (this.player.setClothes.nappac2 == 5) {
            if (this.player.setClothes.level1 == 5) {
                ...
                this.hpMax += ((double) this.hpMax * 110 / 100);
            } else if (this.player.setClothes.level3 == 5) {
                this.hpMax += ((double) this.hpMax * 120 / 100);
            } else if (this.player.setClothes.level4 == 5) {
                this.hpMax += ((double) this.hpMax * 130 / 100);
            } else if (this.player.setClothes.level5 == 5) {
                this.hpMax += ((double) this.hpMax * 140 / 100);
            } else if (this.player.setClothes.level6 == 5) {
                this.hpMax += ((double) this.hpMax * 150 / 100);
            } else if (this.player.setClothes.level7 == 5) {
                this.hpMax += ((double) this.hpMax * 160 / 100);
            }
        ...
        if (this.player.effectSkill.isMonkey && this.player.setClothes.cadicc2 == 5) {
            if (!this.player.isPet || (this.player.isPet
                    && ((Pet) this.player).status != Pet.FUSION)) {
                int percent = SkillUtil.getPercentHpMonkey(player.effectSkill.levelMonkey);
        ...
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isUseTrungThu && this.player.itemTimesieucap.iconBanh == 10904) {
            this.hpMax += ((double) this.hpMax * 10 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isUseTrungThu && this.player.itemTimesieucap.iconBanh == 10905) {
            this.hpMax += ((double) this.hpMax * 20 / 100);
        }
       ...
       if (this.player.setClothes.picolo == 5) {
        ...
        if (this.player.setClothes.picoloc2 == 5) {
            if (this.player.setClothes.level1 == 5) {
                ...
                this.mpMax += ((double) this.mpMax * 110 / 100);
            } else if (this.player.setClothes.level3 == 5) {
                this.mpMax += ((double) this.mpMax * 120 / 100);
            } else if (this.player.setClothes.level4 == 5) {
                this.mpMax += ((double) this.mpMax * 130 / 100);
            } else if (this.player.setClothes.level5 == 5) {
                this.mpMax += ((double) this.mpMax * 140 / 100);
            } else if (this.player.setClothes.level6 == 5) {
                this.mpMax += ((double) this.mpMax * 150 / 100);
            } else if (this.player.setClothes.level7 == 5) {
                this.mpMax += ((double) this.mpMax * 160 / 100);
            }
                ...
                if (player.effectSkill.isCharging && !player.isDie() && !player.effectSkill.isHaveEffectSkill()
                    ...
                    if (player.effectSkill.countCharging % 3 == 0) {
                        try {
                            ...
                            java.util.logging.Logger.getLogger(NPoint.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                } else {
