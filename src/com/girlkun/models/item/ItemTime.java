...
public class ItemTime {
    ...
    public static final int TIME_GIO_DUNG_KEO = 1800000;
    ...
    public int iconDuoi;
    //////Sự kiện hallowen
    public boolean isgiodungkeo;
    public long lastTimegiodungkeo;
    public int icongiodungkeo;
...
//                Service.getInstance().Send_Info_NV(this.player);
        ...
        if (isgiodungkeo) {
            if (Util.canDoWithTime(lastTimegiodungkeo, TIME_GIO_DUNG_KEO)) {
                isgiodungkeo = false;
            }
        }
        if (isUseMayDo2) {
