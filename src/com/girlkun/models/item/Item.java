...
public class Item {
    ...
    public boolean isSKH() {
        for (ItemOption itemOption : itemOptions) {
            if (itemOption.optionTemplate.id >= 127 && itemOption.optionTemplate.id <= 135 || itemOption.optionTemplate.id >= 210 && itemOption.optionTemplate.id <= 211) {
                return true;
            }
        }
        return false;
    ...
    public boolean isSKHCAP2() {
        for (ItemOption itemOption : itemOptions) {
            if (itemOption.optionTemplate.id >= 217 && itemOption.optionTemplate.id <= 234) {
                return true;
            }
        }
        return false;
    ...
    public boolean isSKHVIP() {
        if (this.template.id >= 50) {
            return true;
        }
        return false;
    }

    public boolean ismanhctskh() {
        if (this.template.id >= 1424 && this.template.id <= 1432) {
            return true;
        }
        return false;
    }
