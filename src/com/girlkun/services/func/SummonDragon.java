...
//            = new String[]{"Giàu có\n+200\nNgọc", "+2 Tr\nSức mạnh\nvà tiềm năng", "Giàu có\n+20 Tr\nVàng"};
    ...
    public final int timeResummonShenron = 30000;
//    private final int timeResummonShenron = 0;
    ...
    public void summondragongake(Player pl, boolean appear, byte type) {
        Message msg;
        try {
            msg = new Message(-83);
            msg.writer().writeByte(appear ? 0 : (byte) 1);
    ...
    public void confirmWish() {
        switch (this.menuShenron) {
            ...
            case ConstNpc.SHENRON_1_2:
                Item ao = this.playerSummonShenron.inventory.itemsBody.get(0);
                Item quan = this.playerSummonShenron.inventory.itemsBody.get(1);
                Item gang = this.playerSummonShenron.inventory.itemsBody.get(2);
                Item giay = this.playerSummonShenron.inventory.itemsBody.get(3);
                ...
                switch (this.select) {
                    case 0: // áo sư phụ lên 1 cấp
                        if (ao.isNotNullItem()) {
                            ...
                            if (level < 7) {
                                ...
                                Service.getInstance().sendThongBao(playerSummonShenron, ao.template.name + " của ngươi đã đạt cấp tối đa");
                                reOpenShenronWishes(playerSummonShenron);
                                return;
                            }
                        } else {
                    ...
                    case 1: // quần sư phụ lên 1 cấp
                        if (quan.isNotNullItem()) {
                            ...
                            if (level < 7) {
                                if (level == 0) {
                                    quan.itemOptions.add(new ItemOption(72, 1));
                                }
                                for (ItemOption io : quan.itemOptions) {
                                ...
                                Service.getInstance().sendThongBao(playerSummonShenron, quan.template.name + " của ngươi đã đạt cấp tối đa");
                                reOpenShenronWishes(playerSummonShenron);
                                return;
                            }
                        } else {
                    ...
                    case 2: // găng sư phụ lên 1 cấp
                        if (gang.isNotNullItem()) {
                            ...
                            if (level < 7) {
                                if (level == 0) {
                                    gang.itemOptions.add(new ItemOption(72, 1));
                                }
                                for (ItemOption io : gang.itemOptions) {
                                ...
                                Service.getInstance().sendThongBao(playerSummonShenron, gang.template.name + " của ngươi đã đạt cấp tối đa");
                                reOpenShenronWishes(playerSummonShenron);
                                return;
                            }
                        } else {
                    ...
                    case 3: // giày sư phụ lên 1 cấp
                        if (giay.isNotNullItem()) {
                            ...
                            if (level < 7) {
                                if (level == 0) {
                                    giay.itemOptions.add(new ItemOption(72, 1));
                                }
                                for (ItemOption io : giay.itemOptions) {
                                ...
                                Service.getInstance().sendThongBao(playerSummonShenron, giay.template.name + " của ngươi đã đạt cấp tối đa");
                                reOpenShenronWishes(playerSummonShenron);
                                return;
                            }
                        } else {
                    ...
                    case 4: // rada sư phụ lên 1 cấp
                        if (rada.isNotNullItem()) {
                            ...
                            if (level < 7) {
                                if (level == 0) {
                                    rada.itemOptions.add(new ItemOption(72, 1));
                                }
                                for (ItemOption io : rada.itemOptions) {
                                ...
                                Service.getInstance().sendThongBao(playerSummonShenron, rada.template.name + " của ngươi đã đạt cấp tối đa");
                                reOpenShenronWishes(playerSummonShenron);
                                return;
                            }
                        } else {
