...
public class Manager {
    ...
    public static byte SECOND_WAIT_LOGIN = 7;
    ...
    public static final List<Item> FLAGBAG = new ArrayList<>();
    ...
    public static final String QUERYTOPGAPTHU = "SELECT id, poingapthu FROM player WHERE id NOT IN (SELECT id FROM account WHERE is_admin = 1) AND poingapthu > 0 ORDER BY poingapthu DESC LIMIT 100;";

    public static final String QUERYTOPSANBOSS = "SELECT id, poinBoss FROM player WHERE id NOT IN (SELECT id FROM account WHERE is_admin = 1) AND poinBoss > 0 ORDER BY poinBoss DESC LIMIT 100;";
    ...
    public static final short[] caitrangzamus = {1442};
    public static final byte[] itemIds_NR_SB = {17, 16};
    public static final byte[] itemIds_NR = {20, 19, 18};
    ...
    public static final short[] manhthiensu = {1066, 1067, 1068, 1069, 1070};
    public static final short[] thucan = {663, 664, 665, 666, 667};
    public static final short[] manhtinhan = {1232, 1234, 1233};
    public static final short[] mvbtmhbt = {933, 934}; //mãnh vỡ bông tai mãnh hồn bông tai

    public static final short[] itemsieucap = {1099, 1100, 1101, 1102}; //item cấp 2
    public static final short[] settd = {0, 6, 21, 27, 12}; //set đồ ss trái đất
    public static final short[] setnm = {1, 7, 22, 28, 12}; //set đồ ss namec
    public static final short[] setxd = {2, 8, 23, 29, 12}; //set đồ ss xayda
    ///////////////////////////////////////////////////////////////////
    //////////////////////item sự kiện hallowen///////////////////////
    public static final short[] itemSukienhallowen = {1992, 1995, 1996, 1997}; //kẹo 
    ...
    public void loadDatabase() {
        ...
        try (Connection con = GirlkunDB.getConnection();) {
            ...
            Logger.success("Load top Gắp Thù Thành công (" + topGapThu.size() + ")\n");
            topSanBoss = realTop(QUERYTOPSANBOSS, con);
            Logger.success("Load top Săn Boss Thành công (" + topSanBoss.size() + ")\n");
            try {
                if (rs != null) {
                    rs.close();
                }
            ...
            while (rs.next()) {
                ...
                switch (query) {
                    ...
                    case queryTopSD:
                        ...
                        break;
                    case QUERYTOPGAPTHU:
                        top.setInfo1(rs.getInt("poingapthu") + " lần gắp");
                        top.setInfo2(rs.getInt("poingapthu") + " lần gắp");
                        break;
                    case QUERYTOPSANBOSS:
                        top.setInfo1(rs.getInt("poinBoss") + "Điểm");
                        top.setInfo2(rs.getInt("poinBoss") + "Điểm");
                        break;
                }
                tops.add(top);
            }
