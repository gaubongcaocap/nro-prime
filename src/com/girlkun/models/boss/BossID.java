...
public class BossID {
    ...
    public static final int BOSS_Fushionzamus2 = -264;
    //Doanh Trại
    ...
    public static final int DTWUKONG = -210405215;
//   
//   
    public static final int OngGiaNoel = -43415;
//   
    public static final int GogetaSJJ4 = -2264;
    public static final int kakarot = -2224;
    ...
    public static final int Picolo_Daikamao = -29119023;

    public static final int FIDE = -28;

    public static final int COOLER = -29;
    
         public static final int lanme = -22323229   ;
         ;

    public static final int thucung = -2323229;

    public static final int lancon = -3223229;
    ...
    public static final int gokussj = -32327;
...
//    public static final int TRUNG_UY_TRANG = -200;
    ...
    public static final int Super = -2091;
    ...
    public static final int FUSHIONZAMUS = -2244;
...
//    public static final int BOSS_THOTRANG = -252;
    ...
    public static final int BOSS_Cumber = -262;
    public static final int BOSS_ZenoVIP = -22323;
    public static final int BOSS_Android17 = -26222;

    public static final int BOSS_BabyVegeta = -26223222;
