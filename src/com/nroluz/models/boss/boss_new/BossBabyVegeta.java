 ...
 */
public class BossBabyVegeta extends
        Boss {
    
    public BossBabyVegeta() throws Exception {
        super(BossID.BOSS_BabyVegeta, BossesData.BabyVegeta);
    }
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(80, 100)) {
            if (Util.isTrue(50, 100)) {                
                Service.getInstance().dropItemMap(this.zone, new ItemMap(zone, 1518, Util.nextInt(1, 30), this.location.x, this.location.y, plKill.id));
            } else {
