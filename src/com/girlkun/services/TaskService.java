            ...
            if (player.playerTask.sideTask.isDone()) {
                ...
                switch (player.playerTask.sideTask.level) {
                    ...
                    case ConstTask.NORMAL:
                        gemReward = ConstTask.GOLD_NORMAL;
                ...
                hongngoc.quantity = gemReward;
                InventoryServiceNew.gI().addItemBag(player, hongngoc); //thêm vào
                InventoryServiceNew.gI().addItemBag(player, thoivang); //thêm vào
...
//                switch (player.playerTask.sideTask.level) {
//                    case ConstTask.EASY:
//                        itemToReceive = ItemService.gI().createNewItem((short) 2020);
//                        break;
//                    case ConstTask.NORMAL:
...
//                    InventoryServiceNew.gI().sendItemBags(player);
//                    Service.getInstance().sendThongBao(player, "Chúc mừng bạn đã nhận được quà"  );
//                    player.playerTask.sideTask.reset();
//                }
//            } else {
//                Service.getInstance().sendThongBao(player, "Bạn chưa hoàn thành nhiệm vụ");
...
//    }
    ...
    public void checkDoneSideTaskPickItem(Player player, ItemMap item) {
        if (player != null && player.playerTask != null && player.playerTask.sideTask != null && player.playerTask.sideTask.template != null) {
