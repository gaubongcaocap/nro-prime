...
import static com.girlkun.models.player.Pet.PROTECT;
...
public class Thu_TrieuHoi extends Player {
    ...
    public void update() {
        ...
        if (justRevived1 && this.zone == masterr.zone) {
            Service.getInstance().chatJustForMe(masterr, this, "Chủ nhân ơi con sống dậy rồi !!");
            justRevived1 = false;
        }
        ...
        if (Util.canDoWithTime(masterr.Autothucan, 900000) && masterr.trangthai == true) {
            ...
            if (masterr.TrieuHoiThucAn > 200) {
                ...
                Service.gI().sendThongBao(masterr,
                        "|7|Vì cho Thu cưng CON ăn quá no nên KHỈ CON đã bạo thể mà chết.");
            } else {
                Service.gI().sendThongBao(masterr,
                        "|2|Thức ăn Thú cưng: " + masterr.TrieuHoiThucAn
                        + "%\n|1|Bạn đã cho KHỈ CON ăn\nLưu ý: khi cho quá 200% Thú Cưng sẽ no quá mà chết");
            }
        }
