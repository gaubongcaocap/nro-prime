...
public class ShopDAO {
    ...
    public static void loadShopTab(Connection con, Shop shop) {
        try {
    ...
    public static void loadItemShopOption(Connection con, ItemShop itemShop) {
        try {
            ...
            Logger.logException(ShopDAO.class,
                    e);
            System.out.print(RED + "Lỗi load item shop option" + RESET + "\n");
        }
    }
